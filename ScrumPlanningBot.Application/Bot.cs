...
namespace ScrumPlanningBot.Application
{
    public class Bot : IHostedService
    {
        ...
        public Bot(IChatService chatService, IServiceProvider serviceProvider, ILogger<Bot> logger, UserService userService)
        {
        ...
        private async void OnChatMessage(object? sender, ChatMessageEventArgs chatMessageArgs)
        {
            ...
            {
                File.AppendAllText(@"./Logger.txt", $"{DateTime.UtcNow}: OnChatMessage - Error {ex.Message}");
